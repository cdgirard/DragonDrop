...
public class LightTestClass extends InputAdapter implements ApplicationListener {
    
    static final int RAYS_PER_BALL = 128;
    static final int BALLSNUM = 5;
    static final float LIGHT_DISTANCE = 160f;
    static final float RADIUS = 1f;
    
    static final float viewportWidth = 960;
    static final float viewportHeight = 640;
  ...
  //  Body hitBody = null;
    ...
    public void create() {
       ...
       // textureRegion = new TextureRegion(new Texture(Gdx.files.internal("images/test/marble.png")));
        bg = new Texture(Gdx.files.internal("images/test/bg.png"));
